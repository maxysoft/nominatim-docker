...
This repository includes a GitHub Actions workflow that automatically builds and publishes Docker images on every push to the master branch.

### Setup Requirements

To enable automatic builds, the repository maintainer needs to configure the following secrets in the GitHub repository settings:
